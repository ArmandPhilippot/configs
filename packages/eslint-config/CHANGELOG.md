...
- 09ab7b0: Bumps dependencies
  - `@eslint-react/eslint-plugin`: ^2.2.2 -> ^2.3.13
  - `@eslint/js`: ^9.38.0 -> ^9.39.1
  - `@typescript-eslint/parser`: ^8.46.1 -> ^8.49.0
  - `@typescript-eslint/utils`: ^8.46.1 -> ^8.49.0
  - `@vitest/eslint-plugin`: 1.3.23 -> 1.5.2
  - `eslint`: >=9.38.0 -> >=9.39.1
  - `eslint`: ^9.38.0 -> ^9.39.1
  - `eslint-plugin-astro`: ^1.3.1 -> ^1.5.0
  - `eslint-plugin-jsdoc`: ^61.1.4 -> ^61.5.0
  - `globals`: ^16.4.0 -> ^16.5.0
  - `typescript-eslint`: ^8.46.1 -> ^8.49.0
